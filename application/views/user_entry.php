<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			User <small>add admin user</small>
			</h3>
			<div class="page-bar">
													...
													* </span>
													...
													<div class="col-md-4">
														<div class="input-group">
															...
															<input type="text" class="form-control" name="username" id="username" placeholder="Provide User Name" />
															
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label">User Email: <span class="required">
													* </span>
													</label>
													<div class="col-md-4">
														<div class="input-group">
															...
															<input type="email" class="form-control" name="useremail" id="useremail" placeholder="Provide User Email" />
													...
													* </span>
													...
													<div class="col-md-4">
														<div class="input-group">
															...
															<input type="password" class="form-control" name="password" id="password" placeholder="Provide Password" />
