<!-- BEGIN PAGE HEADER-->
			...
			<div class="row">
				<div class="col-md-12">
					<!--<form class="form-horizontal form-row-seperated" action="<?php echo base_url(); ?>product/product_add" method="post">-->
						<div class="portlet">
								...
								<div class="tabbable">
									...
									<div class="tab-content no-space">
										...
										<div class="tab-pane" id="tab_images">									
											...
											<form id="fileupload" action="<?php echo base_url(); ?>product/do_upload" method="POST" enctype="multipart/form-data">
